...
//  Description : Marvellous CVFS with 'exit', 'help', 'clear', 'man', and 'creat' commands
//                Includes basic inode management and file creation simulation
        ...
        while(true)
        {
            ...
            else if(iCount == 3)
            {
                if(Command[0].equalsIgnoreCase("creat"))
                {
                    ...
                    {
                        System.out.println("File created successfully with Inode Number : " + iRet);
                    }
                }
            }
            else if(iCount == 4)
