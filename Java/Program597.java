/////////////////////////////////////////////////////////////////////////////
//
//  File Name   : Program597.java
//  Description : Accepts a matrix, displays it, calculates summation, 
//                minimum, maximum, maximum per row, both maximum & minimum, 
//                summation of border elements, summation of even rows, 
//                displays elements equal to sum of their neighbours, and
//                updates such elements to zero.
...
class MatrixOperations
{
    ...
    public void displayNeighboursUpdate()
    {
        for (int i = 0; i < rows; i++)
        {
            for (int j = 1; j < cols - 1; j++)
...
public class Program597
{
    public static void main(String[] args)
    {
        ...
        matrix.displayNeighboursUpdate();
