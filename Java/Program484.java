...
//
//  Description : Demonstrates a study log with date, subject, duration, and 
//                description. Stores multiple records in an ArrayList and 
//                displays only the subject and duration using getter methods.
//
