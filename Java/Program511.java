...
//
//  Description : Array class with Linear, Bi-Directional, Binary (Inc/Dec) 
//                and Efficient Binary searches
//                Includes method to check if array is sorted in increasing order
//
...
public class Program511
{
    public static void main(String[] args)
    {
        ...
        boolean bRet = aobj.CheckSortedInc();

        if(bRet == true)
        {
            System.out.println("Data is sorted in increasing order");
        }
        else
        {
            System.out.println("Data is not sorted in increasing order");
        }
    }
}
