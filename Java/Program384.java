...
//
//  Description : Program to pack all files from a given directory into a single file.
//                - Accepts directory name from the user.
//                - Accepts the name of the pack file to create.
//                - Creates the pack file if it does not exist.
//                - Reads each file in the directory and writes its content into the pack file.
//
