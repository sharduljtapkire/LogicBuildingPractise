...
//
//  Description : Program to demonstrate file copy operation.
//                - Takes source file and destination file names from user.
//                - Reads data from source file using FileInputStream.
//                - Writes data into destination file using FileOutputStream.
//                - Uses buffer (1024 bytes) for efficient copy.
//
