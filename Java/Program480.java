...
//
//  Description : Demonstrates creating multiple StudyLog objects, storing them
//                in an ArrayList, and displaying only those StudyLogs where 
//                Subject is "C" using the overridden toString() method.
//
