...
//                search (with time complexity), and node counting.
//
...
{
    private Node root;
    private int countStatic = 0;  // Used for Count method to mimic static variable in C
    ...
    private void countHelper(Node node)
    {
        ...
        {
            countStatic++;
            countHelper(node.rchild);  // Important: rchild
