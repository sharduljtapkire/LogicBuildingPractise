...
//
//  Description : Marvellous Study Tracker Application with CSV export functionality.
//                Allows inserting new study logs, viewing all logs, and exporting
//                logs to a CSV file.
//
...
class StudyTracker
{
    ...
    public void ExportCSV()
    {
        ...
        try (FileWriter fwobj = new FileWriter(FileName))
        {
            ...
            System.out.println("CSV log created successfully");
        }
        ...
        do
        {
            ...
            switch(iChoice)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    // Placeholder for Summary by Date
                    break;
                case 4:
                    // Placeholder for Summary by Subject
                    break;
                case 5:
                    stobj.ExportCSV();
                    break;
