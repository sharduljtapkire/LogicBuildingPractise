...
//  Description :   Dynamic memory allocation, input, and Find Maximum & Minimum Number in Array
...
class ArrayProblems
{
    public void MaximumMinimum(int[] Arr, int iSize)
    {
...
class Program119
{
    public static void main(String A[])
    {
        ...
        aobj.MaximumMinimum(ptr, iLength);
